...
This section describes how to implement uuthentication and uuthorization over websockets with {idm-name}. For more information on authentication over websockets, read Apollo's https://www.apollographql.com/docs/apollo-server/features/subscriptions/#authentication-over-websocket[Authentication Over Websocket] documention.
