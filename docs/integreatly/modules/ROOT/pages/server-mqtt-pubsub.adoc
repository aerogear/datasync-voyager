...
The xref:realtime-updates-{context}[] section describes how to set up the default `PubSub` provided by `apollo-server`. For a production system, use link:https://npmjs.com/package/@aerogear/graphql-mqtt-subscriptions[MQTT PubSub].
