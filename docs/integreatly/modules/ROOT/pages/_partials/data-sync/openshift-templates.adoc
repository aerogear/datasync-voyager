...
When running on Red Hat Managed Integration templates will be available by Searching `DataSync`  in OpenShift catalog

Source code for templates along with documentation can be found in link:https://github.com/aerogear/datasync-deployment[datasync-deployment] repository.
